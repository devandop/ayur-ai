          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10 animate-fade-in-up">
              <div className="space-y-6">
                {/* BADGE */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm hover:border-primary/40 transition-colors duration-300">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Chat with our AI ayurvedic assistant for instant advice, book smart appointments, and
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <SignUpButton mode="modal">
                  <Button size={"lg"} className="ripple group hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-xl hover:shadow-primary/20">
                    <MicIcon className="mr-2 size-5 group-hover:animate-pulse" />
                    Try voice agent
                  </Button>
                </SignUpButton>

                <SignUpButton mode="modal">
                  <Button size={"lg"} variant={"outline"} className="group hover:scale-105 transition-all duration-300 hover:border-primary/50 hover:bg-primary/5">
                    <CalendarIcon className="mr-2 size-5 group-hover:rotate-12 transition-transform duration-300" />
                    Book appointment
                  </Button>
                </SignUpButton>
              </div>
            ...
            <div className="relative lg:pl-8 animate-slide-in-right">
              {/* GRADIENT ORBS */}
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-gradient-to-br from-primary/20 to-primary/10 rounded-2xl rotate-45 blur-xl animate-float-delayed"></div>
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-primary/15 to-primary/5 rounded-full blur-2xl animate-float-slow"></div>

              {/* Glowing ring behind image */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-[80%] h-[80%] rounded-full bg-gradient-to-r from-primary/10 via-primary/5 to-transparent blur-3xl animate-pulse"></div>
              </div>
